...
&emsp;&emsp; [__1. Kiểu dữ liệu và biến__](#1-kiểu-dữ-liệu-số-nguyên)

&emsp;&emsp; [__2. Chú thích trong Java__](#2-kiểu-dữ-liệu-số-thực)

&emsp;&emsp; [__3. Khai báo biến, nhập và hiển thị giá trị của biến__](#3-kiểu-dữ-liệu-đúng-sai)

&emsp;&emsp; [__4. Toán tử__](#4-kiểu-dữ-liệu-ký-tự)
...
b. Hiển thị giá trị của biến ra màn hình:
...
c. Nhập giá trị cho biến từ bàn phím thông qua đối tượng của lớp `Scanner`
